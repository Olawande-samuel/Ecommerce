...
console.log($("#drawer-wrapper").width())
...
document
  ...
  .addEventListener("click", function (e) {
    e.preventDefault();
    document
      .getElementsByClassName("products-panel")[0]
      .classList.toggle("hide");
    document
      .getElementsByClassName("customer-panel")[0]
      .classList.toggle("hide");
  });
...
$(".productdetails").on("click", function (e) {
  ...
  var prices = [];
  $("#items-number").html(
    document.getElementsByClassName("quantity").length + " item"
  );
 ...
 ;(function ($, window) {
    ...
    var tabElements = (function () {
      ...
      function getDefaultLeftArrow(settings) {
        ...
        '  <span class="' + settings.cssClassLeftArrow +' fas fa-angle-left"></span>',
        '</div>'
        ].join('');
      }
      ...
      function getDefaultRightArrow(settings) {
        return [
          ...
          '  <span class="' + settings.cssClassRightArrow + ' fas fa-angle-right"></span>',
          '</div>'
        ].join('');
      }
